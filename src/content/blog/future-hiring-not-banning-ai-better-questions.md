...
Is it AI use if a candidate asks a tool to summarize the company’s public website before the call? What if they use an [AI interview preparation workspace](https://extrabrain.app) before the interview, the same way another candidate practices with a career coach?
...
A privacy-conscious [local-first AI meeting copilot](https://extrabrain.app) is a useful model here: AI support should keep users in control of sensitive conversation context, not turn hiring into a hidden data pipeline.
