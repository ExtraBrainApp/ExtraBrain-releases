...
The purpose of this page is to help users working with visible prompts, code, slides, docs, dashboards, and diagrams combine what is said with what is visible on screen.
...
screen context AI assistant is not only a checkbox in a settings panel.

It changes how much control you have over code editors, shared slides, design diagrams, and that control affects both usefulness and privacy.
...
For this route, the most useful context usually includes code editors, shared slides, and design diagrams.
...
For screen context AI assistant, keep the live prompts short and practical.
...
For screen context AI assistant, tag mistakes by category instead of treating them as one generic performance problem.
...
Useful next reads include [use-cases/system-design-interviews](/use-cases/system-design-interviews/), [use-cases/coding-interviews](/use-cases/coding-interviews/), [privacy](/privacy/).
