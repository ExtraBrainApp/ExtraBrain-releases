...
The purpose of this page is to help people using AI around sensitive interviews and meetings control what is captured, stored, and sent to providers.
...
private AI assistant is not only a checkbox in a settings panel.

It changes how much control you have over private session notes, provider choices, local history, and that control affects both usefulness and privacy.
...
For this route, the most useful context usually includes private session notes, provider choices, and local history.
...
For private AI assistant, keep the live prompts short and practical.
...
For private AI assistant, tag mistakes by category instead of treating them as one generic performance problem.
...
Useful next reads include [privacy](/privacy/), [data-flow](/data-flow/), [features/local-transcription](/features/local-transcription/).
