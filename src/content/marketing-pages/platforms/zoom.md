...
The purpose of this page is to help people using Zoom for recruiter screens, technical interviews, customer calls, and team meetings capture audio and screen context from a desktop workflow without adding a meeting bot.
...
## How ExtraBrain fits with Zoom

Zoom is the environment where part of the work happens, but it is not the whole interview or meeting.
...
It should not modify, submit, or automate work inside Zoom.
...
For this route, the most useful context usually includes remote interviews, shared screens, and follow-up notes.
...
For Zoom interviews and meetings, keep the live prompts short and practical.
...
Before a Zoom session, test the basics.
...
For Zoom interviews and meetings, tag mistakes by category instead of treating them as one generic performance problem.
...
Useful next reads include [use-cases/ai-assistant-for-video-calls](/use-cases/ai-assistant-for-video-calls/), [use-cases/meetings](/use-cases/meetings/), [features/private-ai-assistant](/features/private-ai-assistant/).
